    ...
    <>
      <section className="w-full flex flex-col items-center">
        <div className="pt-16 flex justify-center flex-col text-center space-y-8">
          ...
          <p className="px-16 text-xl font-semibold bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% text-transparent bg-clip-text">
